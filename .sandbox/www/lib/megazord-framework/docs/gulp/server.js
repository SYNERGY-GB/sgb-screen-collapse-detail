...
gulp.task('docs:serve', ['dgeni', 'docs:wiredep', 'assets:serve'], function () {
	browserSyncInit(['.tmp', 'app'], ['app/*.html', 'app/src/**/*']);
	gulp.watch(['config/templates/**/*', 'content/**/*', '../src/**/*.js'], ['dgeni', browserSync.reload]);
    gulp.watch(['assets/**/*.*'], ['assets:serve', browserSync.reload]);
});
